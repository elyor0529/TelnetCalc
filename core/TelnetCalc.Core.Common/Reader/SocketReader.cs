...
namespace TelnetCalc.Core.Common
{
    ...
    public class SocketReader
    {
        ...
        private readonly IConnectionProxy _socketConnection;

        public SocketReader(Socket socket) : this(new ConnectionProxy(socket))
        {
        }
        public SocketReader(IConnectionProxy socketConnection)
        {
